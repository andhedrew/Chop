...
#			new_region_rect.size.x /= 2
#			sprite.region_rect = new_region_rect
#			# Adjust hurtbox and collision shape
#			var new_hurtbox_shape = hurtbox_collision_shape.shape
#			new_hurtbox_shape.extents.x /= 2
#			hurtbox_collision_shape.shape = new_hurtbox_shape
#			var new_collision_shape = collision_shape.shape
#			new_collision_shape.extents.x /= 2
...
#			# Adjust hurtbox and collision shape
#			var new_hurtbox_shape = hurtbox_collision_shape.shape
#			new_hurtbox_shape.extents.y /= 2
#			hurtbox_collision_shape.shape = new_hurtbox_shape
#			var new_collision_shape = collision_shape.shape
#			new_collision_shape.extents.y /= 2
#			collision_shape.shape = new_collision_shape
#
#	# Add pop up motion to simulate impact
#	linear_velocity = pop_up_velocity
